...
class Pengembalian extends CI_Controller
{
    ...
    public function index()
    {
      # code...
        ...
        $data['chart']		= $this->Report_model->show_all_data();
		    $this->load->view('kembali/report', $data);
    ...
    public function periode() {
        ...
        $result = $this->Report_model->show_data_by_date_ranges($data);
        if ($result != false) {
        ...
        if($this->input->post('cetak')){
          ...
          //$sum = $this->Report_model->sum($data);
          //$data['sum'] = $sum;
          $html = $this->load->view('kembali/table_report', $data, true);
    ...
    public function bulanan() {
        ...
        $result = $this->Report_model->show_data_by_dates($data);
        if ($result != false) {
        $data['result_display'] = $result;
        } else {
        $data['result_display'] = "No record found !";
        ...
        if($this->input->post('cetak')){
          ...
          //$sum = $this->Report_model->sum2($data);
          //$data['sum'] = $sum;
          $html = $this->load->view('kembali/reportpdf', $data, true);
