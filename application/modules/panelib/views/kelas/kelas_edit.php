<form action="<?php echo $action; ?>" method="post">
	    ...
	    <div class="form-group">
            ...
            <select name="jurusan[]" id="jurusan[]" class="form-control">
                ...
                <option value="IPA" <?php if (in_array("IPA",$jurusan)) {echo "selected";}?>>Ilmu Pengetahuan Alam</option>
                <option value="IPS" <?php if (in_array("IPS",$jurusan)) {echo "selected";}?>>Ilmu Pengetahuan Sosial</option>
                <option value="BAHASA" <?php if (in_array("BAHASA",$jurusan)) {echo "selected";}?>>BAHASA</option>
                <option value="Lainnya" <?php if (in_array("Lainnya",$jurusan)) {echo "selected";}?>>Lainnya</option>
            </select><br>
            ...
            <select name="jurusan[]" id="jurusan[]" class="form-control" required>
                ...
                <?php
                    ...
                    while($number <= 10){
                        $number++;
                ?>
                <option value="<?php echo $number;?>" <?php if (in_array($number,$jurusan)) {echo "selected";}?>><?php echo $number; ?></option>
                <?php
                    }
                ?>
            </select>
