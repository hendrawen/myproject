      ...
      <section id="main-content">
        ...
        <div class="panel panel-flat">
          <div class="panel-heading" align="center">
            <h5 class="panel-title"><i class="icon-calendar52 position-left"></i> Laporan Pengembalian Buku <!-- <?php echo $this->session->userdata('company'); ?> --></h5>
          </div>
        </div>
        ...
        <!-- /default alerts -->
                    <div class="row">
                       ...
                       <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h6 class="panel-title">Pengembalian Periode</h6>
                     ...
                     <div class="panel-body">
                        <?php echo form_open("report/pengembalian/periode"); ?>
                        <div class="row">
                            <div class="col-md-6">
            ...
            <div class="col-lg-6">
                       <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h6 class="panel-title">Pengembalian Bulanan</h6>
                                    <div class="heading-elements">
                                        <ul class="icons-list">
                                  <li><a data-action="collapse"></a></li>
                                  <li><a data-action="reload"></a></li>
                ...
                <div class="panel-body">
                  <?php echo form_open("report/pengembalian/bulanan"); ?>
                <div class="row">
                 <div class="col-md-6">
                    <div class="form-group">
              ...
              <div class="text-right">
                ...
                $date4 = $this->input->post('tahun');
                  ...
                  echo "<div class='panel panel-flat'  id='printTable'>
                                    <div class='panel-heading'>
                                        <h5 class='panel-title'>Data Pengembalian Buku $date1 - $date2 $date3 $date4</h5>
                                    </div>
                  ...
                  echo "<thead>
                                        <tr>
                                            ...
                                            <th data-hide='phone'>Terlambat</th>
                                            <th data-hide='phone'>Denda</th>
                  ...
                  echo '<tbody>
                        <tr>' . '<td>' . $value->kode_anggota . '</td>' 
                              ...
                              . '<td>' . number_format($value->denda,0,",",".") . '</td>' 
                              . '<td>' . $value->status . '</td>' . 
                        '<tr/>
                        </tbody>';
